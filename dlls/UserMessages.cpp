...
void LinkUserMessages()
{
	...
	if (gmsgRelicCarrier <= 0 || gmsgRelicSync <= 0 || gmsgRelicPoisn <= 0 || gmsgRelicPsnVl <= 0)
		ALERT(at_error, "Relic Rush: echec enregistrement messages RelicCarr/RelicSyn/RelicPoisn/RelicPsnVl\n");
